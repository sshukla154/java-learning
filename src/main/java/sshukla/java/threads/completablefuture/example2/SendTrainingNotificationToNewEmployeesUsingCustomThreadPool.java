 ...
 */
public class SendTrainingNotificationToNewEmployeesUsingCustomThreadPool {
    ...
    private static Void sendReminderToEmployees() throws InterruptedException, ExecutionException {
        ...
        CompletableFuture<Void> completableFuture = CompletableFuture
                .supplyAsync(getEmployeesFromDBSupplier, executor)
                .thenApplyAsync(filterOutOldEmployeesFunction, executor)
                .thenApplyAsync(isTrainingDoneForOldEmployeesFunction, executor)
                .thenApplyAsync(trainingPendingEmployeesFunction, executor)
                .thenAcceptAsync(sendNotificationToPendingEmployeesConsumer, executor);
